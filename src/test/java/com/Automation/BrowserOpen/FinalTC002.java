...
public static void getDataFromExcelSheet(String SheetName) throws Exception {
	...
	// System.out.println(row);iphone
     ...
     min=(int) row.getCell(CellCount-1).getNumericCellValue();
     max=(int) row.getCell(CellCount-2).getNumericCellValue();
