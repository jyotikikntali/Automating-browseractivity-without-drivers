...
public class RowAfterRow {
	...
	public static void main(String[] args) throws IOException, InterruptedException, URISyntaxException, AWTException {
		  ...
		  getDataFromExcelSheet("Sheet1");
			...
			private static void OpenAction(String browser) {
				try {
...
Thread.sleep(5000);
	...
	for (Element result : searchResults) {
		            ...
		            if (titleElement != null && linkElement != null) {
		                ...
		                System.out.println("Fetched base Url from sheet  is:"+SearchUrl);
		...
		e.printStackTrace();
	             System.out.println("there was an error while fetching data or opening browser or while finding the url");  
	}
			}
		...
		System.out.println(Reqdata);
			...
			private static void Scrolling(int value) throws AWTException {
				Robot r =new Robot();
	...
	private static void FalseClickInRef(String url) throws AWTException, IOException, InterruptedException, URISyntaxException {
		...
		try {
			...
			//Element Reqdata=PageData.selectFirst("//span[@class='chapternav-label']");
				...
				System.out.println("Will scroll the present Ref Url page");
				 Thread.sleep(2000);
				 Scrolling(value);
				 System.out.println("Scrolled the present Ref Url Page ");
				 /*long startTime = System.currentTimeMillis();
	                long endTime =  (startTime + (value * 1000));
	...
	private static void OpenNewLink(String link) throws IOException, URISyntaxException, InterruptedException, AWTException {
		...
		System.out.println("In OpenNewLink Method");
		...
		/*Desktop.isDesktopSupported();
          ...
          Desktop.getDesktop().browse(new URI(link));}*/
            Thread.sleep(5000);
            	...
            	System.out.println("scrolling the base page");
            	Scrolling(value);
            	/*long startTime = System.currentTimeMillis();
                long endTime =  (startTime + (value * 1000));
            	    ...
            	    System.out.println("Scrolled the base page");
            	  
	}
		catch(Exception e) {
			System.out.println("The OpenNewLink method couldn't get executed due to a error");
			e.printStackTrace();
		...
		private static void  ClearCookiesAndCache() throws AWTException {
...
public static void getDataFromExcelSheet(String SheetName) throws EncryptedDocumentException, IOException {
	...
	System.out.println("Total rows in the sheet is:"+TotalRows);
	int i=1;
    ...
    //break;
		...
		e.printStackTrace();
		System.out.println("getDataFromExcelSheet Method couldn't get executed might be because of sheet");
		}}
	}
